...
<head>
		<meta charset = "utf-8">
		<title>Residential: For Sale</title>
  ...
  <div class="container-fluid">
	...
	<ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="index.php"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
		...
		<h1 id = "commHeading">RESIDENTAIL PROPERTY FOR SALE</h1>
			...
			<?php
					...
					$imgSQL = "SELECT i.imagePath, p.propID,p.heading, p.summDescription, p.numBeds, p.numBaths, p.numGarages, p.price FROM image as i, property as p where i.propNo = p.propID and p.rentSale = '$sale' and p.commercialResidential = 'Residential'
	...
	$query = "SELECT COUNT(p.propID) AS numrows FROM property as p, image as i where p.propID = i.propNo and p.commercialResidential = 'Residential' and p.rentSale = 'sale' ";
